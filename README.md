...
<h3>Usage</h3>
<p>Make sure you are using Linux and this app only for <b>Chrome</b>.</p>
<p>Using sqlite3 and developed on python 2.7.4. Nothing fancy so should compatible with the latest versions of <a href="http://www.python.org/">Python</a>.</p>
